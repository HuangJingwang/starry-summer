...
describe('ContentController', () => {
  ...
  test('normalizes public content list filters', () => {
    ...
    controller.listPublic('note', 'popular');
  ...
  test('rejects unsupported public content types', () => {
    ...
    expect(() => controller.listPublic('essay', undefined)).toThrow('Unsupported content type: essay');
  ...
  test('rejects unsupported public content sort modes', () => {
    ...
    expect(() => controller.listPublic(undefined, 'oldest')).toThrow('Unsupported content sort: oldest');
    expect(contentService.listPublic).not.toHaveBeenCalled();
  });
});
