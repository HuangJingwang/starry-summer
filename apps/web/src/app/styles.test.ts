...
describe('global styles', () => {
  ...
  test('anchors the home latest article card with the reference homepage geometry', () => {
    ...
    expect(latestCardBlock).toContain('height: var(--reference-article-height);');
    expect(latestCardBlock).toContain('min-height: var(--reference-article-height);');
  ...
  test('uses a single card navigation on the portfolio home page while keeping the night skin dark', () => {
    ...
    expect(homeHeroContentBlock).toContain('--reference-article-height: 160px;');
    ...
    expect(homeHiAvatarBlock).toContain('height: 120px;');
    expect(homeHiAvatarBlock).toContain('width: 120px;');
    ...
    expect(homeHiGreetingBlock).toContain('font-size: 1.5rem;');
    expect(homeHiLineBlock).toContain('overflow-wrap: anywhere;');
    expect(homeHiMeetLineBlock).toContain('max-width: 8.2ch;');
    expect(homeHiNameBlock).toContain('color: var(--cyber-cyan);');
    expect(homeHiNameBlock).toContain('font-size: 32px;');
    expect(homeHiNameBlock).not.toContain('-webkit-text-fill-color: transparent;');
    ...
    expect(homeNavLinkBlock).toContain('min-height: 47px;');
    ...
    expect(homeNavKickerBlock).toContain('margin: 18px 0 0;');
    ...
    expect(homeNavFooterBlock).toContain('margin-top: 8px;');
    expect(homeNavFooterBlock).toContain('padding-top: 8px;');
    expect(homeNavThemeBlock).toContain('box-sizing: border-box;');
    expect(homeNavThemeBlock).toContain('height: 38px;');
    expect(homeNavThemeBlock).toContain('padding: 8px;');
    expect(homeNavThemeBlock).toContain('width: 38px;');
  ...
  test('keeps the portfolio home card navigation usable on mobile', () => {
    ...
    expect(mobileHomeNavBlock).toContain('width: min(360px, 100%);');
    ...
    expect(mobileIntroCardBlock).toContain('padding: 22px 20px 24px;');
    expect(mobileIntroCardBlock).toContain('translate: none;');
    expect(mobileActionsBlock).toContain('grid-area: actions;');
    expect(mobileActionsBlock).toContain('justify-self: center;');
    expect(mobileActionsBlock).toContain('margin-top: 0;');
    expect(mobileActionsBlock).toContain('width: min(360px, 100%);');
    ...
    expect(mobileLatestCardBlock).toContain('padding: 16px 18px 18px;');
    expect(mobileLatestCardBlock).toContain('translate: none;');
    expect(mobileLatestCardBlock).toContain('width: min(360px, 100%);');
    ...
    expect(mobileLeetCodeCardBlock).toContain('padding: 18px;');
    expect(mobileLeetCodeCardBlock).toContain('translate: none;');
    expect(mobileLeetCodeCardBlock).toContain('width: min(360px, 100%);');
    expect(mobileLatestCardLinkBlock).toContain('grid-template-columns: 52px minmax(0, 1fr);');
    expect(mobileLatestCardLinkBlock).toContain('gap: 6px 12px;');
    expect(mobileLatestCoverBlock).toContain('width: 52px;');
