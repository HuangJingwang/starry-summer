...
export function JournalFooter() {
  return <footer className="journal-footer">
    <div className="journal-footer__top"><p>Aster<span>Aster.H 的文章、项目与日常记录。</span></p><Link href="/about">认识一下 <ArrowUpRight size={19} /></Link></div>
    ...
    <div className="journal-footer__bottom"><span>© Aster.H</span><nav aria-label="页脚导航"><a href="https://github.com/HuangJingwang" target="_blank" rel="noopener noreferrer">GitHub</a><Link href="/about">关于</Link><a href="/rss.xml">RSS ↗</a></nav></div>
  </footer>;
}
